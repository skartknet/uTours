 ...
 */
const T = globalThis, I = T.ShadowRoot && (T.ShadyCSS === void 0 || T.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, q = Symbol(), K = /* @__PURE__ */ new WeakMap();
let rt = class {
  constructor(t, e, s) {
...
const dt = (r) => new rt(typeof r == "string" ? r : r + "", void 0, q), pt = (r, ...t) => {
...
}, Z = I ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: $t, defineProperty: _t, getOwnPropertyDescriptor: ft, getOwnPropertyNames: At, getOwnPropertySymbols: yt, getPrototypeOf: mt } = Object, f = globalThis, F = f.trustedTypes, gt = F ? F.emptyScript : "", D = f.reactiveElementPolyfillSupport, w = (r, t) => r, R = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? gt : null;
      break;
  ...
  return e;
} }, V = (r, t) => !$t(r, t), G = { attribute: !0, type: String, converter: R, reflect: !1, useDefault: !1, hasChanged: V };
...
v.elementStyles = [], v.shadowRootOptions = { mode: "open" }, v[w("elementProperties")] = /* @__PURE__ */ new Map(), v[w("finalized")] = /* @__PURE__ */ new Map(), D == null || D({ ReactiveElement: v }), (f.reactiveElementVersions ?? (f.reactiveElementVersions = [])).push("2.1.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C = globalThis, k = C.trustedTypes, Q = k ? k.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, nt = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, ot = "?" + _, vt = `<${ot}>`, g = document, x = () => g.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", W = Array.isArray, Et = (r) => W(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", L = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, X = /-->/g, Y = />/g, A = RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), tt = /'/g, et = /"/g, ht = /^(?:script|style|textarea|title)$/i, bt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), St = bt(1), E = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), st = /* @__PURE__ */ new WeakMap(), y = g.createTreeWalker(g, 129);
function at(r, t) {
...
const wt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, p, l = -1, u = 0;
    for (; u < h.length && (n.lastIndex = u, p = n.exec(h), p !== null); ) u = n.lastIndex, n === S ? p[1] === "!--" ? n = X : p[1] !== void 0 ? n = Y : p[2] !== void 0 ? (ht.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = A) : p[3] !== void 0 && (n = A) : n === A ? p[0] === ">" ? (n = i ?? S, l = -1) : p[1] === void 0 ? l = -2 : (l = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? A : p[3] === '"' ? et : tt) : n === et || n === tt ? n = A : n === X || n === Y ? n = S : (n = A, i = void 0);
    const $ = n === A && r[a + 1].startsWith("/>") ? " " : "";
    o += n === S ? h + vt : l >= 0 ? (s.push(c), h.slice(0, l) + nt + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
    ...
    for (; (i = y.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(nt)) {
          ...
          h.push({ type: 1, index: o, name: N[2], strings: $, ctor: N[1] === "." ? Pt : N[1] === "?" ? xt : N[1] === "@" ? Ut : j }), i.removeAttribute(l);
...
class M {
  ...
  _$AI(t, e = this) {
    t = b(this, t, e), U(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== E && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Et(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class j {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let n = !1;
    if (o === void 0) t = b(this, t, e, 0), n = !U(t) || t !== this._$AH && t !== E, n && (this._$AH = t);
    else {
      const a = t;
      let h, c;
      for (t = o[0], h = 0; h < o.length - 1; h++) c = b(this, a[s + h], e, h), c === E && (c = this._$AH[h]), n || (n = !U(c) || c !== this._$AH[h]), c === d ? t = d : t !== d && (t += (c ?? "") + o[h + 1]), this._$AH[h] = c;
    }
    n && !i && this.j(t);
  }
  j(t) {
...
z == null || z(O, M), (C.litHtmlVersions ?? (C.litHtmlVersions = [])).push("3.3.0");
const Ht = (r, t, e) => {
...
var it;
P._$litElement$ = !0, P.finalized = !0, (it = m.litElementHydrateSupport) == null || it.call(m, { LitElement: P });
const B = m.litElementPolyfillSupport;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Mt = { attribute: !0, type: String, converter: R, reflect: !1, hasChanged: V }, Nt = (r = Mt, t, e) => {
...
var Tt = Object.defineProperty, ct = (r, t, e, s) => {
...
const J = class J extends P {
  constructor() {
    super(...arguments), this.header = "Hey there", this.counter = 5;
  }
  __increment() {
    this.counter += 1;
  }
...
J.styles = pt`
    :host {
      display: block;
      padding: 25px;
      color: var(--test-otjer-text-color, #000);
    }
  `;
let H = J;
ct([
...
window.customElements.define("utours-editor", H);
